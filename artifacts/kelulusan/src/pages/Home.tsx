      ...
      <div className="max-w-2xl mx-auto px-4 pb-16">
        ...
        <footer style={{ borderTop: "1px solid hsl(195 20% 85%)" }}
          ...
          <p className="text-[10px] text-center uppercase tracking-[0.2em] mt-2" style={{ color: "hsl(195 20% 60%)" }}>
            Made with ❤️ by <a href="https://instagram.com/_rippkiiii" target="_blank" rel="noopener noreferrer" className="font-bold hover:underline" style={{ color: "hsl(195 100% 40%)" }}>Miki</a>
          </p>
        </footer>
      </div>
    </div>
